...
| COLLISION 코드 | **2,781** | 같은 코드·다른 이름 → 검토 큐 |
...
- [ ] 전량 적재 실행 → 결과가 위 기대 규모(canonical≈323,899, superseded≈291,610)와 일치 확인
- [ ] 적재 후 ServingOption 행 수 ≤ canonical × 제공량 옵션 상한 확인 (옵션 폭증 0)
